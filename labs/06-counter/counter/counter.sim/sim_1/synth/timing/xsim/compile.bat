...
REM
REM Generated by Vivado on Thu Mar 16 11:22:40 +0100 2023
...
echo "xvlog --incr --relax -prj tb_cnt_up_down_vlog.prj"
call xvlog  --incr --relax -prj tb_cnt_up_down_vlog.prj -log xvlog.log
